    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4 sm:p-6">
                ...
                <form method="POST" action="{{ route('cards.destroy', $card->id) }}" onsubmit="return confirm('ATENÇÃO: Deletar esta categoria apagará TODOS os cards vinculados a ela. Confirmar exclusão?')">
                    @csrf
                    @method('DELETE')
